# class CollapsingHeader : public ContainerGUIElement<std::shared_ptr<GUIElement>>
handles Collapsing Headers.<br>

## public CollapsingHeader(std::string name)
constructor for the CollapsingHeader class.<br>

### params:
* std::string name - the name of the Collapsing Header.<br>

## public void terminate() override
terminates the Collapsing Header.<br>

## public void render() override
renders the Collapsing Header.<br>
